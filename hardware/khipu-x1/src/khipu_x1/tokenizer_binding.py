...
def bind_tokenizer_artifacts(
    ...
    *,
    ...
    tokenizer_config_raw = captured.get("tokenizer_config.json")
    tokenizer_config = (
        _parse_json("tokenizer_config.json", tokenizer_config_raw)
    ...
    special_map_raw = captured.get("special_tokens_map.json")
    special_map = (
        _parse_json("special_tokens_map.json", special_map_raw)
